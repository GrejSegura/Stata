...
summarize winamount if code_outlet==`outlet' & tagall==1 & control==2
drop if winamount== r(max) & control==2
...
while _totdc > totavg {
summarize winamount if code_outlet==`outlet' & tagall==1 & control==1
drop if winamount== r(max) & control==1  
...
/*
while _totdsb < _totdc {
summarize winamount if code_outlet==`outlet' & tag_big==1 & control==1
drop if winamount== r(max) & control==1 
...
replace winamount=. if excluded==1
save "/Users/Grejell/Desktop/Data Analysis/JWMMD/Reports/Data/JWMMD 2016_10_RAW_final3.dta", replace
...
outsheet date time room booking_id trx_code description rate_code market_code folio control excluded code_outlet code_topic code_type amount ORN total_amount_control using "/Users/Grejell/Desktop/Data Analysis/JWMMD/Reports/Data/JWMMD 2016_10 nooutliers FlatFile_2.csv", comma replace
